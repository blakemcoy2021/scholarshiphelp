<?php
    ...
    try {
        ...
        if (count($rowctr) < 1) {
            $data['success'] = "zero";
            $data['message'] = "No Row Results For Awarding Scholarship Applications!";
        ...
        $data['success'] = $ctr;
        $data['message'] = "Acquired sum value of For Awarding Scholarship Application!";
        $data['logs'] = "Scholarship Applications For Awarding total is $ctr.";
        echo json_encode($data);
