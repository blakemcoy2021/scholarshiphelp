<?php
    ...
    try {
        ...
        if (count($rowctr) < 1) {
            $data['success'] = "zero";
            $data['message'] = "No scholarship applications For Awarding recorded!";
            $data['logs'] = "Scholarship Applications For Awarding Not Found.";
            echo json_encode($data);
            $conn = null;
            die();
        }
        ...
        $data['message'] = "Successfully acquired Scholarship Applications For Awarding!";
        $data['logs'] = "List of Scholarship Applications For Awarding Found.";
